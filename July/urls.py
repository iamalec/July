...
from django.conf.urls.static import static    #solve the problem that it can not load media files
...
] + static(settings.MEDIA_URL, document_root=settings.MEDIA_ROOT)   #solve the problem that it can not load media files
